public class Main {
    public static void main(String[] args) {
        ...
        Bus hyundai = new Bus("Hyundai", "Avante", 1.6, boris, Bus.PassengerCapacity.EXTRA_SMALL );
        Bus ural = new Bus("Урал", "Next", 20.22, boris, Bus.PassengerCapacity.SMALL );
        Bus paz = new Bus(" Паз", "Вектор Next", 20.20, boris, Bus.PassengerCapacity.AVERAGE);
        Bus мercedes = new Bus("Mercedes-Benz", "Tourismo", 20.21, boris, Bus.PassengerCapacity.BIG);
        Truck kamaz = new Truck("Камаз", "компас", 12.45, oleg, Truck.LoadCapacity.N1);
        Truck zil = new Truck("Зил", "43", 24.12, oleg, Truck.LoadCapacity.N2);
        Truck man = new Truck("Man", "TGL", 12.45, oleg, Truck.LoadCapacity.N3);
